...
public class LightFile : JsonFile {
	...
	public float ShadowNear { get; set; } = 0;
	public float ShadowFar { get; set; } = 0;
	public FalloffType FalloffType { get; set; }
	public Vector2 AreaAngle { get; set; } = Vector2.Zero;
	public float Falloff { get; set; } = 0;
	public float LightAngle { get; set; } = 0;
	public float FalloffAngle { get; set; } = 0;
	public float Range { get; set; } = 0;
	public float CharaShadowRange { get; set; } = 0;
}
