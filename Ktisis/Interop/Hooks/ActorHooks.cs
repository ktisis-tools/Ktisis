...
namespace Ktisis.Interop.Hooks {
	internal static class ActorHooks {
		...
		internal static void Init() {
			...
			var slotSpeed = Services.SigScanner.ScanText("83 FA 0E ?? ?? 8B C2 F3 0F 10 84 81 54 01 00 00 0F 2E C2 ?? ?? ?? ?? F3 0F 11 94 81");
			SetSlotSpeedHook = Hook<SetSlotSpeedDelegate>.FromAddress(slotSpeed, SetSlotSpeedDetour);
