...
namespace Ktisis.Interop {
	internal class Methods {
		...
		internal delegate IntPtr RemoveStatusEffectDelegate(IntPtr writeTo, int statusIndex, byte u2);
		internal static RemoveStatusEffectDelegate? StatusRemoveEffect;
		...
		internal static void Init() {
			...
			StatusRemoveEffect = Retrieve<RemoveStatusEffectDelegate>("83 FA 1E ?? ?? 53 48 83 EC 30 48 8B D9 8B C2 45 0F B6 D0 44 88 54 24 20 4C");
