...
public class CustomizeIpcProvider {
	...
	public CustomizeIpcProvider(
		...
		this._unsetTemporaryProfileGuid = dpi.GetIpcSubscriber<Guid, int>("CustomizePlus.Profile.DeleteTemporaryProfileByUniqueId");
	}
	...
	public int DeleteTemporaryProfileGuid(Guid id) => this._unsetTemporaryProfileGuid.InvokeFunc(id);
